...
const handleAddToCart = (product) => { 
  ...
  setAddedToCart((prevState) => ({...prevState, [product.name]: true,
      ...
      {plantsArray.map(category => (
        <div key={category.category}>
           ...
           <div className="product-list">
            {category.plants.map(renderPlantCard)}
      </div>
    </div>
))}
</div>
    ...
    return (
          ...
          setShowPlants(true); }} style={styleA}>Plants</a>
           <a href="#" onClick={() => setShowCart(true)} style={styleA}> 
            ...
            {showCart ? <CartItem onContinueShopping={handleContinueShopping} /> : renderProductList()}
             </div>
           );
        }
